...
pub struct Workspace {
    ...
    preferences: p7z_core::settings::Preferences,
    appearance: p7z_core::settings::Appearance,
    tasks: task::TaskState,
    browser: Browser,
    address: Entity<InputState>,
    address_dirty: bool,
    history: Vec<p7z_core::settings::recent::Entry>,
    ...
    update_status: Option<p7z_requests::update::Status>,
    ...
    update_transfer: Option<p7z_requests::update::Progress>,
...
impl Workspace {
    pub fn new(
        startup: p7z_core::settings::StartupSettings,
        window: &mut Window,
        cx: &mut Context<Self>,
    ) -> Self {
        ...
        let mut workspace = Self {
            ...
            preferences: p7z_core::settings::Preferences::default(),
