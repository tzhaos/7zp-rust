...
pub(super) struct PreferencesForm {
    ...
    shortcut_recording: Option<p7z_core::settings::shortcuts::ShortcutAction>,
    ...
    pub fn new(
        ...
        let font_family = cx.new(|cx| {
            InputState::new(window, cx)
                ...
                .placeholder(p7z_core::settings::Appearance::default().font_family)
        });
        ...
        Self {
            ...
            font_family,
            font_size: p7z_core::settings::Appearance::clamp_font_size(appearance.font_size),
            association_popup,
