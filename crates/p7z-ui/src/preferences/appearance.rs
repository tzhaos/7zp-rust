...
impl PreferencesForm {
    pub(super) fn appearance_page(&self, cx: &mut Context<Self>) -> Div {
        ...
        let minimum_size = p7z_core::settings::Appearance::MIN_FONT_SIZE;
        let maximum_size = p7z_core::settings::Appearance::MAX_FONT_SIZE;
        let size_step = p7z_core::settings::Appearance::FONT_SIZE_STEP;
        settings_group(
            [
                settings_detail(
                    tr("theme-menu"),
                ...
                settings_detail(
                    ...
                    settings_action("appearance-reset", tr("appearance-reset"), cx)
                        ...
                        .on_click(cx.listener(|this, _, window, cx| {
                            let default = p7z_core::settings::Appearance::default();
