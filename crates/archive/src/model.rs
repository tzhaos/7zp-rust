...
impl Format {
    ...
    pub fn from_shell(format: sevenzip_shell_api::ArchiveFormat) -> Self {
        match format {
            sevenzip_shell_api::ArchiveFormat::SevenZip => Self::SevenZip,
            sevenzip_shell_api::ArchiveFormat::Zip => Self::Zip,
        }
    }
