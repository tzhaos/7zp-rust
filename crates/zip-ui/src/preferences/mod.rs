...
pub(super) struct PreferencesForm {
    ...
    shortcut_recording: Option<zip_core::settings::shortcuts::ShortcutAction>,
    ...
    pub fn new(
        ...
        let font_family = cx.new(|cx| {
            InputState::new(window, cx)
                ...
                .placeholder(zip_core::settings::Appearance::default().font_family)
        });
        ...
        Self {
            ...
            language: zip_core::i18n::current(),
            font_family,
            font_size: zip_core::settings::Appearance::clamp_font_size(appearance.font_size),
            association_popup,
