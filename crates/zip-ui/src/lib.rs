...
use zip_engine::{Cancellation, Catalog, CreateOptions, Edit, Entry, Overwrite};
use zip_requests::{Outcome, Request, browser::Browser};
...
pub struct Workspace {
    ...
    active_tab_indicator: std::rc::Rc<std::cell::Cell<components::panel::TabIndicator>>,
    preferences: zip_core::settings::Preferences,
    appearance: zip_core::settings::Appearance,
    tasks: task::TaskState,
    browser: Browser,
    address: Entity<InputState>,
    address_dirty: bool,
    history: Vec<zip_core::settings::recent::Entry>,
    ...
    update_status: Option<zip_requests::update::Status>,
    ...
    update_transfer: Option<zip_requests::update::Progress>,
    language_task: Option<Task<()>>,
    launches: std::collections::VecDeque<Vec<String>>,
    after_open: Option<zip_platform::ExplorerAction>,
    dragging: bool,
...
impl Workspace {
    pub fn new(
        startup: zip_core::settings::StartupSettings,
        window: &mut Window,
        cx: &mut Context<Self>,
    ) -> Self {
        ...
        let mut workspace = Self {
            ...
            active_tab_indicator: std::rc::Rc::new(std::cell::Cell::new(Default::default())),
            preferences: zip_core::settings::Preferences::default(),
