...
- Product copy belongs in locales/zh-CN.ftl, zh-TW.ftl and en-US.ftl. Keep semantic keys and parameter names aligned. Use complete Fluent messages for variable text.
...
- Explorer commands receive the complete IShellItemArray. Keep the shell DLL independent of GPUI and the archive engine; share only action definitions, format routing and request data through shell-api.
