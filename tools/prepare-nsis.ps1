...
# SourceForge serves an HTML interstitial to PowerShell's browser-style user agent.
Invoke-WebRequest -Uri 'https://downloads.sourceforge.net/project/nsis/NSIS%203/3.12/nsis-3.12.zip' -UserAgent 'Wget/1.21.4' -OutFile $archive
